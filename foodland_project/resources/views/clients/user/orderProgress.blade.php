        ...
        <div class="grid__full-width">
            <nav class="header__navbar">
                ...
                <ul class="header__navbar-nav">
                    ...
                    <li class="header__navbar-item">
                        <a href="{{route('order.progress')}}" class="header__item-link header__item-link--active">Order</a>
                    </li>
                    <li class="header__navbar-item">
                        ...
                        <div class="grid__col-4-8">
                            <div class="order__cart-option">
                                ...
                                <div class="order__cart-voucher">
                                    ...
                                    <input type="text" class="order__voucher-input mt-16" value="{{($voucher!='')?$voucher->CODE:''}}" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="order__pay-wrapper grid__col-4">
                    <div class="order__pay-bill">
                        ...
                        <ul class="order__bill-info-list">
                            <h1 class="order__info-header">Delivery items (<span class="order__cart-quantity">{{count($latestOrderDetail)}}</span>)
                            </h1>
                            <li class="order__info-list-item">
                                <p class="order__item-header">Sub-total</p>
                                <p class="order__item-price order__sub-total">{{$latestOrder->TotalPrice - 27000}} VND</p>
                            </li>
                            <li class="order__info-list-item">
