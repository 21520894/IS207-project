...
@if(session('order_status'))
    @php(toastr()->success('Order successfully!'))
@endif
<div class="app">
    ...
    <section id="order__page">
        ...
        <h2 class="order__page-sub-header">Refresh page to see the updated status</h2>
        <ul class="order__progress-bar">
            ...
            <li class="progress__icon-wrapper">
                ...
                <span class="progress__name">Processing</span>
            </li>
            <li class="progress__icon-wrapper">
