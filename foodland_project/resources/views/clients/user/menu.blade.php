    ...
    <div class="menu__page-container grid__full-width grid__row">
        <div class="menu__order-wrapper grid__col-8">
            <div class="menu__search">
                ...
                <input type="text" class="menu__search-input" id="search_dish"
            ...
            <div class="menu__product-list-wrapper menu__product-scroll-btn--active">
                <span class="menu__product-scroll-btn btn--hover btn-left"><i
                ...
                <span class="menu__product-scroll-btn btn--hover btn-right"><i
