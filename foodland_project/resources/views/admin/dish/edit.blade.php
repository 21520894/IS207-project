        ...
        <div class="grid__row">
            <div class="edit__page">
                <form class="edit__page-wrapper" action="" method="POST" id="edit-dish-form">
                    @csrf
                    <img class="edit__page-img" id="up-product-image" src="" alt="">
                    <div class="edit__page-input-wrapper">
                        <div class="edit__input-group-wrapper">
                            ...
                            <div class="edit__input-group">
                                ...
                                <input type="text" class="edit__input-text" name="up_name" id="up_name">
                        ...
                        <div class="edit__input-group-wrapper">
                            <div class="edit__input-group">
                                <label for="" class="edit__input-label">Price (VND) <span
                                        class="edit__input-require">*</span></label>
                                <input type="number"  class="edit__input-text" name="up_price" id="up_price">
                        ...
                        <div class="edit__input-group">
                            <label for="" class="edit__input-label">Status<span
                                    class="edit__input-require">*</span></label>
                            <select name="up_status" id="" class="edit__input-text">
                        ...
                        <div class="edit__input-group">
                            <label for="" class="edit__input-label">Describe <span
                                    class="edit__input-require">*</span></label>
                            <textarea class="edit__input-text" name="up_description" cols="30" rows="5" id="up_description">
                                </textarea>
                            <span style="color: red; font-size: 12px;" class="up_description_error error"></span>
                        </div>
                        <div class="edit__input-group">
                            <label for="" class="edit__input-label">Image</label>
                            <input type="file" class="edit__input-text" id="up_image" name="up_image">
                            <span style="color: red; font-size: 12px;" class="up_image_error error"></span>
                        </div>
