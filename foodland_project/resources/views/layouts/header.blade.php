            ...
            <ul class="header__navbar-nav">
                ...
                @else
                    <li class="header__navbar-item" name="signin">
                        <a href="" onclick="return false;" class="header__item-link">CART</a>
                    </li>
                @endauth
            ...
            @auth
                ...
                <div class="header__navbar-user">
                    ...
                    <div class="header__user-controls">
                        <p class="header__user">Hello, <span class="header__user-name">{{ Auth::user()->name }}</span>
                        </p>
            ...
            @else
                ...
                <ul class="header__navbar-control">
                    ...
                    <li class="header__navbar-item header__cart">
                        ...
                        @else
                            <a href="" onclick="return false;" class="header__item-btn" name="signin">
                                <i class="header__cart-icon fa-solid fa-cart-shopping"></i>
                            </a>
                        @endauth
                    </li>
