...
<head>
    ...
    <meta name="keywords"
          content="Foodland, Food land, food website, foodland website, foodland demo, foodland design website"/>
    {{--    <script>--}}
    ...
    <div class="modal__body">
                ...
                <div class="auth-form__form">
                    ...
                    <div class="auth-form__aside">
                        <div class="auth-form__help">
                            <div class="auth-form__help-link auth-form__help--forgot" name="forgot">Forgot password?
                            </div>
                        </div>
                    </div>
        ...
        <form class="auth-form" id="signupModal" name="signupModal" action="{{ route('register') }}" method="POST">
            ...
            <div class="auth-form__container">
                ...
                <div class="auth-form__form">
                    ...
                    <div class="auth-form__group">
                        <input type="password" class="auth-form__input-text" placeholder="Confirm password"
        ...
        <form class="auth-form" id="forgotModal" name="forgotModal" action="{{route("password.email")}}" method="POST">
            ...
            <div class="auth-form__container">
                ...
                <div class="auth-form__form">
                    <div class="auth-form__group">
                        <input type="email" class="auth-form__input-text mt-32" placeholder="Email" name="email"
                               required>
        ...
        <div class="detail__product-wrapper" name="productDetailModal">
            ...
            <div class="detail__product">
                ...
                <p class="detail__product-desc">Our Beef Wellington is made with the finest ingredients, including prime
                    beef tenderloin, wild mushrooms, and imported puff pastry.
                    <br>The steak is seasoned to perfection and seared over high heat to lock in the juices, then
                    wrapped in the duxelles and puff pastry. The Wellington is then baked until the pastry is golden
                    brown and the steak is cooked to your desired doneness.
                    <br>Beef Wellington is typically served with a side of mashed potatoes and asparagus, but it can
                    also be paired with a variety of other vegetables, such as green beans, roasted carrots, or Brussels
                    sprouts. For a truly special meal, add a side of truffle oil or foie gras butter.
                </p>
...
<script>
    $(document).ready(function () {
        ...
        //Menu tab
        $(document).on('click', '.menu__category-item', function (e) {
            e.preventDefault();
            let category_type = $(this).find('.menu__category-item-name').text();
            $('.menu__category-item--active').removeClass('menu__category-item--active');
            $(this).addClass('menu__category-item--active')
            $.ajax({
                url: "{{route('clients.dish.show.category')}}",
