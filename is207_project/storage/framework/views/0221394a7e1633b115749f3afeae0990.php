        ...
        <nav class="header__navbar">
            ...
            <ul class="header__navbar-nav">
                <li class="header__navbar-item">
                    <a href="<?php echo e(route('home_page')); ?>" class="header__item-link header__item-link--active">Home</a>
                </li>
                <li class="header__navbar-item">
                    <a href="<?php echo e(route('menu_page')); ?>" class="header__item-link">Menu</a>
                </li>
                <li class="header__navbar-item">
                    <a href="<?php echo e(route('order_page')); ?>" class="header__item-link">Order</a>
                </li>
                <li class="header__navbar-item">
            ...
            <?php if(auth()->guard()->check()): ?>
                ...
                <a href="" onclick="return false;" class="header__item-btn">Welcome, <?php echo e(Auth::user()->name); ?>!</a> <!-- Hiển thị tên người dùng -->
...
<?php endif; ?>
                ...
                <li class="header__navbar-item header__cart">
                    <a href="<?php echo e(route('order_page')); ?>" class="header__item-btn">
...
<!-- End of Header -->
<?php /**PATH D:\subject_learning\is207\wamp64\www\IS207_project_git\is207_project\resources\views/layouts/header.blade.php ENDPATH**/ ?>