...
<div class="modal">
    ...
    <div class="modal__body">
        <!-- Sign in form -->
        <form class="auth-form" name="signinModal" action="<?php echo e(route('login')); ?>" method="POST">
            <?php echo csrf_field(); ?>
        ...
        <!-- Sign up form -->
        <form class="auth-form" name="signupModal" action="<?php echo e(route('register')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="auth-form__container">
                <div class="auth-form__header">
...
<?php /**PATH D:\subject_learning\is207\wamp64\www\IS207_project_git\is207_project\resources\views/layouts/clients.blade.php ENDPATH**/ ?>