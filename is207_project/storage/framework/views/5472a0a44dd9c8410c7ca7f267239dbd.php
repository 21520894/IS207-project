        ...
        <nav class="header__navbar">
            ...
            <div class="header__navbar-user">
                ...
                <div class="header__user-controls">
                    <p class="header__user">Hello, <span class="header__user-name"><?php echo e(Auth::user()->name); ?></span></p>
...
<!-- End of Header -->
<?php /**PATH D:\subject_learning\is207\wamp64\www\IS207_project_git\is207_project\resources\views/admin/components/header.blade.php ENDPATH**/ ?>