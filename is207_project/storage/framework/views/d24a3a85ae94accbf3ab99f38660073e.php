...
<head>
    ...
    <title>Foodland - Manager Page</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/8.0.1/normalize.min.css">
    <link rel="stylesheet" href="<?php echo e(asset('admin_style/css/admin_base.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('admin_style/css/admin_main.css')); ?>">
...
<script type="text/javascript" src="<?php echo e(asset('admin_style/js/getParentElement.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('admin_style/js/menuActive.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('admin_style/js/categoryActive.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('admin_style/js/modal.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('admin_style/js/editCategory.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('admin_style/js/itemStatus.js')); ?>"></script>
<?php echo $__env->yieldContent('js'); ?>
</html>
<?php /**PATH D:\subject_learning\is207\wamp64\www\IS207_project_git\is207_project\resources\views/layouts/admin.blade.php ENDPATH**/ ?>