...
<body>
    <div class="app">
        ...
        <!-- Menu staff -->
        <section id="menu__page" class="menu__staff-page">
            <div class="menu__page-container grid__full-width grid__row">
                <div class="menu__order-wrapper grid__full-width">
                ...
                <div class="menu__user-wrapper grid__row grid__full-width">
                    <div class="grid__col-4-8">
                        <div class="menu__cart-item-wrapper">
                            <h1 class="menu__cart-header">My Cart</h1>
                        </div>
                        <select class="menu__cart-table" name="" id="" onchange="const selectTable = document.querySelector('.menu__cart-table'); document.querySelector('.order__cart-table').innerText = selectTable.value;">
                    ...
                    <!-- Order page -->
                    <div id="order__page" class="order__staff-page grid__col-4-8">
                        <div class="order__page-container">
                            <div class="order__cart-container"  style="display: none">
                            ...
                            <div class="order__pay-wrapper">
                                <div class="order__pay-bill">
                                    <h1 class="order__bill-header">Order Summary</h1>
                                    <ul class="order__bill-info-list">
                                        <h1 class="order__info-header">Items (<span class="order__cart-quantity">0</span>)</h1>
                                        <h1 class="order__info-header">Table 0<span class="order__cart-table"></span></h1>
                                        ...
                                        <li class="order__info-list-item" style="display: none">
